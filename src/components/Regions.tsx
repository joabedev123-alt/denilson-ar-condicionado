        ...
        <div className="flex flex-wrap justify-center gap-3">
          {regions.map((region, i) => (
            <motion.div
              ...
              className="glass-card rounded-full px-5 py-2.5 border border-blue-500/15 hover:border-blue-400/35 hover:bg-blue-500/8 transition-all duration-200 cursor-default group"
            >
              <span className="flex items-center gap-2 text-slate-400 group-hover:text-blue-300 text-sm transition-colors duration-200">
                <i className="bi bi-geo-alt text-blue-500/60 group-hover:text-blue-400 text-xs transition-colors" />
                {region}
              </span>
            </motion.div>
          ))}
